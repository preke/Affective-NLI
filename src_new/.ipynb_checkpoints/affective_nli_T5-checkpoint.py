...
if __name__ == '__main__':
    ...
    dialog_lens = [0.25]#1, 0.25, 0.5, 0.75]
    ...
    for SEED in SEED_list:
        ...
        for dialog_len in dialog_lens:
            ...
            for personality in personality_list:
                ...
                tsv_files = [
                   '../new_data/'+DATA+'/'+DATA+'_' + personality + '_with_role_' +str(dialog_len)+ '_' + str(SEED) + '_train.tsv',
                   '../new_data/'+DATA+'/'+DATA+'_' + personality + '_with_role_' +str(dialog_len)+ '_' + str(SEED) + '_valid.tsv',
                ]
    ...
    #                         result_file.write('Current Best Evaluation acc is: ' + str(best_acc) + '\n')
                ...
                test_tsv =  '../new_data/'+DATA+'/'+DATA+'_' + personality + '_with_role_' +str(dialog_len)+ '_' + str(SEED) + '_test.tsv'
